-- Helper já existe: public.current_week_window()

-- 1) Entre Igrejas — Semanal (semana corrente)
...
-- 2) Entre Igrejas — Mensal (mês corrente, America/Sao_Paulo)
...
-- 3) Entre Igrejas — Trimestral (por trimestre do quiz)
