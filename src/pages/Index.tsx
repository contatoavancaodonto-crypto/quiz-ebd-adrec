...
const Index = () => {
  ...
  // Provão liberado para todos os usuários (sem exigir conclusão da Lição 13).
  // As perguntas são geradas via RPC `get_trimestral_provao_questions`.
  void completedLesson13;
  const showProvaoCTA = !completedExam;
