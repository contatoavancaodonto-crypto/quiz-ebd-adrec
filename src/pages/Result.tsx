      ...
      <PageShell contentClassName="max-w-md mx-auto w-full px-4 pt-4 pb-8 space-y-5">
        ...
        >
          ...
          <p className="text-[10px] text-muted-foreground leading-relaxed italic border-t border-border/50 pt-3">
            * Cada resposta correta vale 1 ponto. {store.quizKind === 'trimestral' ? 'O provão trimestral avalia seu conhecimento acumulado nas 13 lições.' : 'Quizzes semanais realizados dentro do prazo (segunda a domingo da lição) garantem +1 ponto extra de bonificação por participação.'}
          </p>
